...
#+BEGIN_SRC python :session :exports results :results graphics file :file images/distribs.png
fig_path = 'images/distrib.png'
# fig, ax = plt.subplots(nrows=1, ncols=1, dpi=60,
#                          figsize=(10,15))
# sns.histplot(meta, x='abnormality', hue="target", ax=ax)
